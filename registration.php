                ...
                <div class="d-flex align-items-center" >
                    ...
                    <form id="registerForm" style="width: 23rem;" >
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="registerFirstName" class="form-control form-control-lg" />
                            <label class="form-label text-secondary" for="registerFirstName">First Name</label>
                        </div>

                        <div class="form-outline mb-4">
                            <input type="text" id="registerLastName" class="form-control form-control-lg" />
                            <label class="form-label text-secondary" for="registerLastName">Last Name</label>
                        </div>

                        <div class="form-outline mb-4">
                            <input type="email" id="registerEmail" class="form-control form-control-lg" />
                            <label class="form-label text-secondary " for="registerEmail">Email address</label>
                        </div>

                        <div class="form-outline mb-4">
                            <input type="password" id="registerPassword" class="form-control form-control-lg" />
                            <label class="form-label text-secondary" for="registerPassword">Password</label>
                        </div>

                        <div class="form-outline mb-4">
                            <input type="password" id="registerConfirmPassword" class="form-control form-control-lg" />
                            <label class="form-label text-secondary" for="registerConfirmPassword">Confirm Password</label>
                        </div>
