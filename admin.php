...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index.php">
        <img src="Images/logo.png" width="30" height="30" class="d-inline-block align-top" alt="Logo"> Symphony Official Store </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            if ((isset($_SESSION["users_username"]))&&($_SESSION["users_is_admin"]===1)){
                ...
                echo "
											<li class='nav-item'>
												<a class='nav-link' href='admin.php'>MY ADMIN</a>
											</li>";
                echo "
											<li class='nav-item'>
...
<div class="container-fluid p-md-4 p-lg-5">
    ...
    <div class="container-fluid pb-3 pt-0 px-0 ">
        ...
        <a type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#addProduct"> Add Product</a>
